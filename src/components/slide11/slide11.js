        ...
        return (
            <div className={"slide11"}>
                ...
                <div className={"wrapper-slide5"}>
                    ...
                    {this.state.complete ? <button className="main-button" onClick={this.props.nextSlide}>Next</button> : null}
                    <img src="./m.png" alt="none" className={this.state.slova[0].class + this.state.slova[0].animation} id="0" onClick={this.click} />
                    <img src="./m.png" alt="none"  className={this.state.slova[1].class + this.state.slova[1].animation} id="1" onClick={this.click} />
                    <img src="./m.png" alt="none"  className={this.state.slova[2].class + this.state.slova[2].animation} id="2" onClick={this.click} />
                </div>
            </div>
        );
    }
